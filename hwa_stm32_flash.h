...
#define HWA_FLASH_PRFTBE		HWA_ACR, 0b1,   4
#define HWA_FLASH_LATENCY		HWA_ACR, 0b111, 0
#define HWA_FLASH_LATENCY_0WS		0b000			/* RESET */
#define HWA_FLASH_LATENCY_1WS		0b001
#define HWA_FLASH_LATENCY_2WS		0b010

#define HWA_FLASH_BSY			HWA_SR, 0b1, 0

#define HWA_FLASH_STRT			HWA_CR, 0b1, 6
#define HWA_FLASH_OPTER			HWA_CR, 0b1, 5
#define HWA_FLASH_OPTPG			HWA_CR, 0b1, 4
#define HWA_FLASH_PG			HWA_CR, 0b1, 0
