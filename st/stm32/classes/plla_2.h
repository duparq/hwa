...
#define _hw_cfplla(o,i,a,k,...)		do{ HW_Y(_hwx_cfplla_k,k)(_hw,k,__VA_ARGS__) }while(0)
#define _hwa_cfplla(o,i,a,k,...)	do{ HW_Y(_hwx_cfplla_k,k)(_hwa,k,__VA_ARGS__) }while(0)

/*  At least one keyword
 */
#define _hwx_cfplla_k_1(h,k,...)	HW_E_ML((source, multiplier))
#define _hwx_cfplla_k_0(h,k,...)	HW_Y(_hwx_cfplla_ksrc,_hw_is_source_##k)(h,k,__VA_ARGS__)

/*  Optionnal parameter `source`
 */
#define _hwx_cfplla_ksrc_1(h,k,v,...)	HW_Y(_hwx_cfplla_vsrc,_hw_cnplla_##v)(h,v,__VA_ARGS__)
...
#define _hwx_cfplla_ksrc_0(h,k,...)	HW_Y(_hwx_cfplla_kmul,_hw_is_multiplier_##k)(h,k,__VA_ARGS__)
...
#define _hw_cnplla(o,i,a,v,g,...)	do{ HW_Y(_hwx_cnplla1)(_hw,v,g) }while(0)
#define _hwa_cnplla(o,i,a,v,g,...)	do{ HW_Y(_hwx_cnplla1)(_hwa,v,g) }while(0)
#define _hwx_cnplla1_0(h,v,g)		HW_E_G(g)
#define _hwx_cnplla1_1(h,v,g)		HW_Y(_hwx_cnplla2,_hw_cnplla_##v)(h,v,_hw_cnplla_##v)
...
#define _hw_wrplla(o,i,a,v,g,...)	do{ HW_Y(_hwx_wrplla,g)(_hw,v,g) }while(0)
#define _hwa_wrplla(o,i,a,v,g,...)	do{ HW_Y(_hwx_wrplla,g)(_hwa,v,g) }while(0)
...
#define _hw_tnplla(o,i,a,v,g,...)	HW_Y(_hwx_tnplla)(_hw,v,g)
#define _hwa_tnplla(o,i,a,v,g,...)	HW_Y(_hwx_tnplla)(_hwa,v,g)
