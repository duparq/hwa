 ...
 * @defgroup stm32_plla Class _plla: PLL
 *
 * `configure`:
 * @code
...
#define _hw_cfplla(o,a,k,...)		do{ HW_B(_hwx_cfplla_k_,k)(_hw,k,__VA_ARGS__) }while(0)
#define _hwa_cfplla(o,a,k,...)		do{ HW_B(_hwx_cfplla_k_,k)(_hwa,k,__VA_ARGS__) }while(0)

/*  At least one keyword
 */
#define _hwx_cfplla_k_1(h,k,...)	HW_E(HW_EM_AML((source,multiplier)))
#define _hwx_cfplla_k_0(h,k,...)	HW_B(_hwx_cfplla_ksrc_,_hw_is_source_##k)(h,k,__VA_ARGS__)

/*  Optionnal parameter `source`
 */
#define _hwx_cfplla_ksrc_1(h,k,v,...)	HW_B(_hwx_cfplla_vsrc_,_hw_cnplla_##v)(h,v,__VA_ARGS__)
#define _hwx_cfplla_vsrc_0(h,v,...)	HW_E(HW_EM_XNIL(v,(hsi/2, hse, hse/2)))
#define _hwx_cfplla_vsrc_1(h,v,k,...)	_hwx_cnplla2_1(h,v,_hw_cnplla_##v) _hwx_cfplla_ksrc_0(h,k,__VA_ARGS__)

#define _hwx_cfplla_ksrc_0(h,k,...)	HW_B(_hwx_cfplla_kmul_,_hw_is_multiplier_##k)(h,k,__VA_ARGS__)
...
#define _hw_cnplla(o,a,v,g,...)		do{ HW_B(_hwx_cnplla1_,g)(_hw,v,g) }while(0)
#define _hwa_cnplla(o,a,v,g,...)	do{ HW_B(_hwx_cnplla1_,g)(_hwa,v,g) }while(0)
#define _hwx_cnplla1_0(h,v,g)		HW_E(HW_EM_G(g))
#define _hwx_cnplla1_1(h,v,g)		HW_B(_hwx_cnplla2_,_hw_cnplla_##v)(h,v,_hw_cnplla_##v)
#define _hwx_cnplla2_0(h,v,xv)		HW_E(HW_EM_XNIL(v,(hsi/2, hse, hse/2)))
...
#define _hwx_cnplla3(h,v,z,xv)						\
  ...
  else HWA_E(HW_EM_VL(v,(hsi/2, hse, hse/2)));
...
#define _hw_wrplla(o,a,v,g,...)	do{ HW_B(_hwx_wrplla_,g)(_hw,v,g) }while(0)
#define _hwa_wrplla(o,a,v,g,...)	do{ HW_B(_hwx_wrplla_,g)(_hwa,v,g) }while(0)
#define _hwx_wrplla_0(h,v,g)		HW_E(HW_EM_G(g))
...
#define _hw_tnplla(o,a,v,g,...)	HW_B(_hwx_tnplla_,g)(_hw,v,g)
#define _hwa_tnplla(o,a,v,g,...)	HW_B(_hwx_tnplla_,g)(_hwa,v,g)

#define _hwx_tnplla_0(h,v,g)		HW_E(HW_EM_G(g))
#define _hwx_tnplla_1(h,v,g)		HW_B(_hwx_tnplla2_,_hw_state_##v)(h,v)
#define _hwx_tnplla2_0(h,v)		HW_E(HW_EM_ST(v))
