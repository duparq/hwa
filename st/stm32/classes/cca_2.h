 ...
 */
#define _hwx_cfcca0(h,c,n,k,...)	HW_YW(_hwx_cfcca_kfun,function,k)(h,c,n,k,__VA_ARGS__)
#define _hwx_cfcca_kfun0(h,c,n,k,...)	HW_E_NIL(k,(function))
#define _hwx_cfcca_kfun1(h,c,n,k,v,...)	HW_YW(_hwx_cfcca_vmod,compare,v)(h,c,n,v,__VA_ARGS__)
#define _hwx_cfcca_vmod0(h,c,n,v,...)	HW_E_TBIKV(function,v)
#define _hwx_cfcca_vmod1(h,c,n,v,k,...)			\
  h##_write(c,cc##n##s,0);				\
  HW_YW(_hwx_cfcca_krul,rule,k)(h,c,n,k,__VA_ARGS__)
...
#define _hwx_cfcca_vrul1(h,c,n,v,k,...)			\
  ...
  HW_YW(_hwx_cfcca_kcoe,k,clear_on_etr)(h,c,n,k,__VA_ARGS__)

/*  Optionnal argument 'clear_on_etr'
 */
#define _hw_is_clear_on_etr_clear_on_etr	, 1

#define _hwx_cfcca_kcoe0(h,c,n,k,...)	HW_YW(_hwx_cfcca_klat,k,latch)(h,c,n,k,__VA_ARGS__)
#define _hwx_cfcca_kcoe1(h,c,n,k,v,...)	HW_YS2(_hwx_cfcca_vcoe,v)(h,c,n,v,__VA_ARGS__)
#define _hwx_cfcca_vcoe0(h,c,n,v,...)
#define _hwx_cfcca_vcoe1(r,h,c,n,v,k,...)		\
  h##_write(c,oc##n##ce,r);				\
  HW_YW(_hwx_cfcca_klat,k,latch)(h,c,n,k,__VA_ARGS__)

/*  Optionnal argument 'latch'
 */
#define _hwx_cfcca_klat0(h,c,n,k,...)	HW_YW(_hwx_cfcca_kfst,k,fast)(h,c,n,k,__VA_ARGS__)
#define _hwx_cfcca_klat1(h,c,n,k,v,...)	HW_YS2(_hwx_cfcca_vlat,v)(h,c,n,v,__VA_ARGS__)
#define _hwx_cfcca_vlat0(h,c,n,v,...)
#define _hwx_cfcca_vlat1(r,h,c,n,v,k,...)		\
  h##_write(c,oc##n##pe,r);				\
  HW_YW(_hwx_cfcca_kfst,k,fast)(h,c,n,k,__VA_ARGS__)	

/*  Optionnal argument 'fast'
 */
#define _hwx_cfcca_kfst0(h,c,n,k,...)	HW_YW(_hwx_cfcca_kpol,k,polarity)(h,c,n,k,__VA_ARGS__)
#define _hwx_cfcca_kfst1(h,c,n,k,...)	HW_YS2(_hwx_cfcca_vfst,v)(h,c,n,v,__VA_ARGS__)
#define _hwx_cfcca_vfst0(h,c,n,v,...)
#define _hwx_cfcca_vfst1(r,h,c,n,v,k,...)		\
  h##_write(c,oc##n##fe,r);				\
  HW_YW(_hwx_cfcca_kpol,k,polarity)(h,c,n,k,__VA_ARGS__)

/*  Optionnal argument 'polarity'
 */
#define _hwx_cfcca_kpol0(h,c,n,k,...)	HW_YW(_hwx_cfcca_kout,k,output)(h,c,n,k,__VA_ARGS__)
...
#define _hwx_cfcca_vpol1(h,c,n,v,k,...)			\
  ...
  HW_YW(_hwx_cfcca_kout,k,output)(h,c,n,k,__VA_ARGS__)

/*  Mandatory argument 'output'
 */
#define _hwx_cfcca_kout0(h,c,n,k,...)	HW_E_MA(output)
#define _hwx_cfcca_kout1(h,c,n,k,v,...)	HW_YW(_hwx_cfcca_vout1,connected,v)(h,c,n,v,__VA_ARGS__)
#define _hwx_cfcca_vout11(h,c,n,v,...)	h##_write(c,cc##n##e,1);
#define _hwx_cfcca_vout10(h,c,n,v,...)	HW_YW(_hwx_cfcca_vout2,disconnected,v)(h,c,n,v,__VA_ARGS__)
