 ...
 * @section stm32_ahba_act Actions
 *
 ...
 */
#define _hwx_cfahba_k_1(h,k,...)	HW_E(HW_EM_AML((clock,prescaler)))
...
#define _hwx_cfahba_vsrc_0(h,v,...)	HW_E(HW_EM_VOAL(v,clock,(sysclk))
 ...
 */
#define _hwx_cfahba_kpsc_0(h,k,...)	HW_E(HW_EM_AN(k,prescaler))
