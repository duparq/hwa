...
#define _hw_cfahba(o,i,a,k,...)		do{ HW_X(_hwx_cfahba_k,k)(_hw,k,__VA_ARGS__) }while(0)
#define _hwa_cfahba(o,i,a,k,...)	do{ HW_X(_hwx_cfahba_k,k)(_hwa,k,__VA_ARGS__) }while(0)

/*  At least one keyword
 */
#define _hwx_cfahba_k_1(h,k,...)	HW_E_ML((clock, prescaler))
#define _hwx_cfahba_k_0(h,k,...)	HW_X(_hwx_cfahba_ksrc,_hw_is_clock_##k)(h,k,__VA_ARGS__)

/*  Optionnal parameter `clock`
 */
#define _hwx_cfahba_ksrc_1(h,k,v,...)	HW_X(_hwx_cfahba_vsrc,_hw_is_sysclk_##v)(h,v,__VA_ARGS__)
#define _hwx_cfahba_vsrc_0(h,v,...)	HW_E_OKVL(clock,v,sysclk)
#define _hwx_cfahba_vsrc_1(h,v,k,...)	HW_X(_hwx_cfahba_kpsc,_hw_is_prescaler_##k)(h,k,__VA_ARGS__)
#define _hwx_cfahba_ksrc_0(h,k,...)	HW_X(_hwx_cfahba_kpsc,_hw_is_prescaler_##k)(h,k,__VA_ARGS__)
...
#define _hwx_cfahba_vpsc1_1(h,v,g)	HW_X(_hwx_cfahba_vpsc2,v)(h,v)
