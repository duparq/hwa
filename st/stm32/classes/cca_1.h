...
#define _hw_cca_counter(o,c,...)	_io1a,o,(c,__VA_ARGS__),counter, HW_XO(c)
...
#define _hw_cca_occe(o,c,n)		_c16a,c,(HW_A1(hw_##c)),occe, hw__c16a_oc##n##ce
...
#define _hw_cca_icf(o,c,n)		_c16a,c,(HW_A1(hw_##c)),icf, hw__c16a_ic##n##f

#define hw__cca_ocpe			, _hw_cca_ocpe
#define _hw_cca_ocpe(o,c,n)		_c16a,c,(HW_A1(hw_##c)),ocpe, hw__c16a_oc##n##pe

#define hw__cca_ocfe			, _hw_cca_ocfe
#define _hw_cca_ocfe(o,c,n)		_c16a,c,(HW_A1(hw_##c)),ocfe, hw__c16a_oc##n##fe

#define hw__cca_icpsc			, _hw_cca_icpsc
#define _hw_cca_icpsc(o,c,n)		_c16a,c,(HW_A1(hw_##c)),icpsc, hw__c16a_ic##n##psc

#define hw__cca_ccs			, _hw_cca_ccs
#define _hw_cca_ccs(o,c,n)		_c16a,c,(HW_A1(hw_##c)),ccs, hw__c16a_cc##n##s

#define hw__cca_cce			, _hw_cca_cce
#define _hw_cca_cce(o,c,n)		_c16a,c,(HW_A1(hw_##c)),cce, hw__c16a_cc##n##e

#define hw__cca_ccp			, _hw_cca_ccp
#define _hw_cca_ccp(o,c,n)		_c16a,c,(HW_A1(hw_##c)),ccp, hw__c16a_cc##n##p
