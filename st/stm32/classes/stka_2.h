...
#define _hw_cfstka(o,i,a,k,...)		do{ HW_X(_hwx_cfstka_k,k)(_hw,o,k,__VA_ARGS__) }while(0)
#define _hwa_cfstka(o,i,a,k,...)	do{ HW_X(_hwx_cfstka_k,k)(_hwa,o,k,__VA_ARGS__) }while(0)

/*  At least one keyword
 */
#define _hwx_cfstka_k_1(h,o,k,...)	HW_E_ML((clock,reload))
#define _hwx_cfstka_k_0(h,o,k,...)	HW_X(_hwx_cfstka_kclk,_hw_is_clock_##k)(h,o,k,__VA_ARGS__)

/*  Optionnal parameter `clock`
 */
#define _hwx_cfstka_kclk_1(h,o,k,v,...)	HW_X(_hwx_cfstka_vclk,_hw_cfstka_clk_##v)(h,o,v,__VA_ARGS__)
...
#define _hwx_cfstka_vclk_3(h,o,v,z,xv,k,...)				\
  ...
  HW_X(_hwx_cfstka_krld,_hw_is_reload_##k)(h,o,k,__VA_ARGS__)

#define _hwx_cfstka_kclk_0(h,o,k,...)	HW_X(_hwx_cfstka_krld,_hw_is_reload_##k)(h,o,k,__VA_ARGS__)

/*  Optionnal parameter `reload`
 */
#define _hwx_cfstka_krld_1(h,o,k0,v,k,...)			\
  h##_write_reg(o,reload,(uint32_t)(v));			\
  HW_X(_hwx_cfstka_krn,_hw_is_run_##k)(h,o,k,__VA_ARGS__)

#define _hwx_cfstka_krld_0(h,o,k,...)	HW_X(_hwx_cfstka_krn,_hw_is_run_##k)(h,o,k,__VA_ARGS__)

/*  Optionnal parameter `enabled`
 */
#define _hwx_cfstka_krn_0(h,o,k,...)	HW_EOL(k)
#define _hwx_cfstka_krn_1(h,o,k,v,...)	HW_X(_hwx_cfstka_vrn,_hw_state_##v)(h,o,v,__VA_ARGS__)
...
#define _hwx_tnstka(h,o,v,...)		HW_X(_hwx_tnstka,_hw_state_##v)(h,o,v,__VA_ARGS__)
