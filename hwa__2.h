 ...
 */
#define hw_config(...)			HW_MD(hw_config, __VA_ARGS__)
#define hwa_config(...)			HW_MD(hwa_config, __VA_ARGS__)


/*	hw_clear(...): clear something (generic)
 */
#define hw_clear(...)			HW_MD(hw_clear, __VA_ARGS__)
#define hwa_clear(...)			HW_MD(hwa_clear, __VA_ARGS__)


/*	hw_lock_to_zero(...): clear something and keep it at 0 (generic)
 */
#define hw_lock_to_zero(...)		HW_MD(hw_lock_to_zero, __VA_ARGS__)
#define hwa_lock_to_zero(...)		HW_MD(hwa_lock_to_zero, __VA_ARGS__)


/*	hw_read(...): read something (generic)
 */
#define hw_read(...)			HW_MD(hw_read, __VA_ARGS__)
...
/*	hw/hwa_release(...): release something (generic)
 */
#define hw_release(...)			HW_MD(hw_release, __VA_ARGS__)
#define hwa_release(...)		HW_MD(hwa_release, __VA_ARGS__)


/*	hw_status(...): status of something (generic)
 */
#define hw_status(...)			HW_MD(hw_status, __VA_ARGS__)


/*	hw/hwa_toggle(...): toggle something, (generic but probably an io)
 */
#define hw_toggle(...)			HW_MD(hw_toggle, __VA_ARGS__)
#define hwa_toggle(...)			HW_MD(hwa_toggle, __VA_ARGS__)


/*	hw/hwa_turn(...): turn something on/off (generic)
 */
#define hw_turn(...)			HW_MD(hw_turn, __VA_ARGS__)
#define hwa_turn(...)			HW_MD(hwa_turn, __VA_ARGS__)


/*	hw/hwa_trigger(...): trigger something on/off (generic)
 */
#define hw_trigger(...)			HW_MD(hw_trigger, __VA_ARGS__)
#define hwa_trigger(...)		HW_MD(hwa_trigger, __VA_ARGS__)


/*	hw/hwa_write(...): write something (generic)
 */
#define hw_write(...)			HW_MD(hw_write, __VA_ARGS__)
#define hwa_write(...)			HW_MD(hwa_write, __VA_ARGS__)
