...
#define hw_core_bods		regb, mcucr, 1, 7
#define hw_core_pud		regb, mcucr, 1, 6
#define hw_core_se		regb, mcucr, 1, 5
#define hw_core_sm		regb, mcucr, 2, 3
#define hw_core_bodse		regb, mcucr, 1, 2
#define hw_core_isc0		regb, mcucr, 2, 0

#define hw_core_int0		regb, gimsk, 1, 6
#define hw_core_pcie1		regb, gimsk, 1, 5
#define hw_core_pcie0		regb, gimsk, 1, 4

#define hw_core_intf0		regb, gifr, 1, 6
#define hw_core_pcif1		regb, gifr, 1, 5
#define hw_core_pcif0		regb, gifr, 1, 4
