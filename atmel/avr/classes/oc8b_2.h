...
#define _hw_mthd_hwa_configure__oc8b		, _hwa_cfoc8b
...
#define _hwa_cfoc8b(o,i,a, ...)						\
  do {									\
    HW_GX(_hwa_cfoc8b_kupdate,_hw_is_update_##__VA_ARGS__)(o,__VA_ARGS__,) \
      } while(0)
...
#define _hwa_cfoc8b_kupdate_0(o,kw,...)					\
  HW_GX(_hwa_cfoc8b_koutputh,_hw_oc8b_koutputh_##kw)(o,kw,__VA_ARGS__)
...
#define _hwa_cfoc8b_koutputh_1(o,kw,v,...)				\
  HW_GX(_hwa_cfoc8b_voutputh,_hw_oc8b_voutputh_##v)(o,v,__VA_ARGS__)
...
#define _hwa_cfoc8b_koutputl_1(o,kw,v,...)				\
  HW_GX(_hwa_cfoc8b_voutputl,_hw_oc8b_voutputl_##v)(o,v,__VA_ARGS__)
