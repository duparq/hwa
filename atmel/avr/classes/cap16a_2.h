...
#define _hw_cfcap16a(o,i,a,...)						\
  HW_Y(_hw_cfcap16akw1,_hw_cfcap16a_kw_##__VA_ARGS__)(o,__VA_ARGS__,)
...
#define _hwa_cfcap16a(o,i,a,...) do { HW_Y(_hwa_cfcap16a_kinput,_hw_is_input_##__VA_ARGS__)(o,__VA_ARGS__) } while(0)
