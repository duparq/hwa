...
#define _hw_cfcap16a(o,i,a,...)						\
  HW_X(_hw_cfcap16akw1,_hw_cfcap16a_kw_##__VA_ARGS__)(o,__VA_ARGS__,)
...
#define _hw_cfcap16a_edge(o,v,...)					\
  HW_X(_hw_cfcap16a_vedge,hw_cap16a_edge_##v)(o,v,__VA_ARGS__)
...
#define _hwa_cfcap16a_vedge_1(o,v,k,...)				\
  ...
  HW_X(_hwa_cfcap16a_kfilter,_hw_is_filter_##k)(o,k,__VA_ARGS__)

#define _hwa_cfcap16a_kfilter_0(o,...)		\
  HW_EOL(__VA_ARGS__)

#define _hwa_cfcap16a_kfilter_1(o,k,v,...)				\
  HW_X(_hwa_cfcap16a_vfilter,_hw_state_##v)(o,v,__VA_ARGS__)
