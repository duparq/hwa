...
#define _hw_cfcap16a_edge(o,v,...)					\
  HW_GX(_hw_cfcap16a_vedge,hw_cap16a_edge_##v)(o,v,__VA_ARGS__)
...
#define _hwa_cfcap16a(o,i,a,...)						\
  do {									\
    HW_GX(_hwa_cfcap16a_kinput,_hw_is_input_##__VA_ARGS__)(o,__VA_ARGS__,,) \
      } while(0)
...
#define _hwa_cfcap16a_vinput_1(o,v,k,...)				\
  ...
  HW_GX(_hwa_cfcap16a_kedge,_hw_is_edge_##k)(o,k,__VA_ARGS__)

#define _hwa_cfcap16a_kedge_0(o,k,...)					\
  HW_E_VL(k,edge)

#define _hwa_cfcap16a_kedge_1(o,k,v,...)				\
  HW_GX(_hwa_cfcap16a_vedge,hw_cap16a_edge_##v)(o,v,__VA_ARGS__)
...
#define _hwa_cfcap16a_vedge_1(o,v,k,...)				\
  ...
  HW_GX(_hwa_cfcap16a_kfilter,_hw_is_filter_##k)(o,k,__VA_ARGS__)

#define _hwa_cfcap16a_kfilter_0(o,...)		\
  HW_EOL(__VA_ARGS__)

#define _hwa_cfcap16a_kfilter_1(o,k,v,...)				\
  HW_GX(_hwa_cfcap16a_vfilter,_hw_state_##v)(o,v,__VA_ARGS__)
