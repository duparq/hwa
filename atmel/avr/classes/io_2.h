...
HW_INLINE void _hwa_begin_p__io8a ( hwa_io8a_t *p, intptr_t a )
{
...
HW_INLINE void _hwa_init_p__io8a ( hwa_io8a_t *p )
{
...
HW_INLINE void _hwa_commit_p__io8a ( hwa_t *hwa, hwa_io8a_t *p )
{
...
#define _hwa_begin_p__io6a		_hwa_begin_p__io8a
#define _hwa_init_p__io6a		_hwa_init_p__io8a
#define _hwa_commit_p__io6a		_hwa_commit_p__io8a
...
#define _hw_cfdio_xpullup_1(pn,bn,bp,kw,...)			\
  HW_G2(_hw_cfdio_vpullup, HW_IS(,_hw_state_##__VA_ARGS__))(pn,bn,bp,__VA_ARGS__)

#define _hw_cfdio_vpullup_1(pn,bn,bp,v,...)			\
  _hw_write(_hw_reg_cb1b(pn,port,bn,bp), (HW_A1(_hw_state_##v)?(1U<<bn)-1:0)); \
  HW_TX(,__VA_ARGS__)
...
#define _hwa_cfdio_vdirection_1(p,pn,bn,bp,v,...)			\
  _hwa_write__r8( &hwa->pn.ddr, 0xFF,0, bn,bp, (HW_A1(hw_cfdio_direction_##v)?(1U<<bn)-1:0));	\
...
#define _hwa_cfdio_xpullup_1(p,pn,bn,bp,kw,...)			\
  HW_G2(_hwa_cfdio_vpullup, HW_IS(,_hw_state_##__VA_ARGS__))(p,pn,bn,bp,__VA_ARGS__)

#define _hwa_cfdio_vpullup_1(p,pn,bn,bp,v,...)			\
  _hwa_write__r8( &hwa->pn.port, 0xFF,0, bn,bp, (HW_A1(_hw_state_##v)?(1U<<bn)-1:0) );\
  HW_TX(,__VA_ARGS__)
...
#define _hw_rddio_5(a,bn,bp, rt,ra,rwm,rfm)	_hw_read_r8(a+ra,rwm,rfm,bn,bp)
...
#define _hw_wrdio_5(a,bn,bp,v, rt,ra,rwm,rfm)	_hw_write__r8(a+ra,rwm,rfm,bn,bp,v)

#define _hwa_write_pin1(p,i, pn,bn,bp, v, ...)		\
  HW_TX(_hwa_write__r8(&hwa->pn.port, 0xFF,0x00, bn,bp, v),__VA_ARGS__)
