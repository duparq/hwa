...
#define _hwa_cfctd(o,a,k,...)					\
  do { HW_B(_hwa_cfctd_kclock_,_hw_is_clock_##k)(o,k,__VA_ARGS__,,) } while(0)

#define _hwa_cfctd_kclock_0(o,k,...)				\
  HW_E_VL(k,clock)

#define _hwa_cfctd_kclock_1(o,k,v,...)				\
  HW_B(_hwa_cfctd_vclock_,_hw_c1clk_##v)(o,v,__VA_ARGS__)
...
#define _hwa_cfctd_vclock_1(o,v,k,...)					\
  ...
  HW_B(_hwa_cfctd_kmode_,_hw_is_direction_##k)(o,k,__VA_ARGS__)
...
#define _hwa_cfctd_vbottom_1(o,v,k,...)	\
  HW_B(_hwa_cfctd_ktop_,_hw_is_top_##k)(o,k,__VA_ARGS__)
...
#define _hwa_cfctd_vtop_1(o,v,k,...)					\
  ...
  HW_B(_hwa_cfctd_koverflow_,_hw_is_overflow_##k)(o,k,__VA_ARGS__)
...
#define _hwa_cfctd_koverflow_1(o,k,v,...)				\
  HW_B(_hwa_cfctd_voverflow_,_hw_ctd_overflow_##v)(o,v,__VA_ARGS__)
