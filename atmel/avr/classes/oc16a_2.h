...
#define _hw_cfoc16a(o,i,a, ...)						\
  do {									\
    HW_GX(_hw_cfoc16a_xoutput,_hw_is_output_##__VA_ARGS__)(o,__VA_ARGS__,); \
  }while(0)

#define _hw_cfoc16a_xoutput_0(o,k,...)					\
  HW_E_VL(k,output)
#define _hw_cfoc16a_xoutput_1(o,k,v,...)				\
  HW_GX(_hw_cfoc16a_voutput,_hw_oc16a_output_##v)(o,v,__VA_ARGS__)
...
#define _hwa_cfoc16a(o,i,a,...)						\
  do {									\
    HW_GX(_hwa_cfoc16a_xupdate,_hw_is_update_##__VA_ARGS__)(o,__VA_ARGS__,); \
  }while(0)

#define _hwa_cfoc16a_xupdate_0(o,k,...)					\
  HW_GX(_hwa_cfoc16a_xoutput,_hw_is_output_##k)(o,k,__VA_ARGS__)

#define _hwa_cfoc16a_xupdate_1(o,k,v,...)					\
  HW_GX(_hwa_cfoc16a_vupdate,_hw_oc16a_update_##v)(o,v,__VA_ARGS__)
...
#define _hwa_cfoc16a_xoutput_1(o,k,v,...)				\
  HW_GX(_hwa_cfoc16a_voutput,_hw_oc16a_output_##v)(o,v,__VA_ARGS__)
