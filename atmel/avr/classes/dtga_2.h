...
#define _hwa_cfdtga(o,i,a, ...)						\
  do {									\
    ...
    HW_X(_hwa_cfdtga_kclockdiv,_hw_dtga_kclockdiv_##__VA_ARGS__)(o,__VA_ARGS__,) \
      } while(0)

#define _hwa_cfdtga_kclockdiv_1(o,kw,v,...)				\
  HW_X(_hwa_cfdtga_vclockdiv,HW_A0(_hw_dtga_vclockdiv_##v))(o,v,__VA_ARGS__) \
...
#define _hwa_cfdtga_kclockdiv_0(o,kw,...)				\
  HW_X(_hwa_cfdtga_kcompare0h,_hw_dtga_kcompare0h_##kw)(o,kw,__VA_ARGS__)
...
#define _hwa_cfdtga_kcompare0h_0(o,kw,...)				\
  HW_X(_hwa_cfdtga_kcompare0l,_hw_dtga_kcompare0l_##kw)(o,kw,__VA_ARGS__)
...
#define _hwa_cfdtga_kcompare0l_0(o,kw,...)				\
  HW_X(_hwa_cfdtga_kcompare1h,_hw_dtga_kcompare1h_##kw)(o,kw,__VA_ARGS__)
...
#define _hwa_cfdtga_kcompare1h_0(o,kw,...)				\
  HW_X(_hwa_cfdtga_kcompare1l,_hw_dtga_kcompare1l_##kw)(o,kw,__VA_ARGS__)
