...
#define _hw_cmp8a_output_toggle_after_match	, 1, 1			/* Non-PWM */
#define _hw_cmp8a_output_clear_after_match	, 2, 2			/* Non-PWM */
#define _hw_cmp8a_output_set_after_match	, 3, 3			/* Non-PWM */

#define _hw_cmp8a_output_set_at_bottom_clear_after_match	, 4, 2			/* Fast PWM */
#define _hw_cmp8a_output_clear_at_bottom_set_after_match	, 5, 3
