...
#define _hwa_cfpscb(o,i,a, ...)						\
  do { HW_X(_hwa_cfpscb_kclock,_hw_is_clock_##__VA_ARGS__)(o,__VA_ARGS__,) } while(0)

#define _hw_is_clock_clock		, 1

#define _hwa_cfpscb_kclock_0(o,k,...)		HW_E_VL(k,clock)
#define _hwa_cfpscb_kclock_1(o,k,v,...)		HW_X(_hwa_cfpscb_vclock,_hw_pscb_clock_##v)(o,v,__VA_ARGS__)
