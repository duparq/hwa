...
#define _hw_cfoca(o,a,k,...)					\
  do {									\
    HW_Y(_hw_cfoca_koutput_,_hw_is_output_##k)(o,k,__VA_ARGS__,,);	\
  }while(0)

#define _hw_cfoca_koutput_0(o,k,...)		\
  HW_E_VL(k,output)
#define _hw_cfoca_koutput_1(o,k,v,...)					\
  HW_Y(_hw_cfoca_voutput_,_hw_oca_output_##v)(o,v,__VA_ARGS__)
#define _hw_cfoca_voutput_0(o,v,...)					\
...
#define _hw_cfoca_voutput_1(o,v,...)					\
  _hw_write(o, com, HW_A2(_hw_oca_output_##v)) HW_EOL(__VA_ARGS__)
...
#define _hwa_cfoca(o,a,k,...)					\
  do {									\
    HW_Y(_hwa_cfoca_kupdate_,_hw_is_update_##k)(o,k,__VA_ARGS__,);	\
  }while(0)

#define _hwa_cfoca_kupdate_0(o,k,...)				\
  HW_Y(_hwa_cfoca_koutput_,_hw_is_output_##k)(o,k,__VA_ARGS__)

#define _hwa_cfoca_kupdate_1(o,k,v,...)				\
  HW_Y(_hwa_cfoca_vupdate_,_hw_oca_update_##v)(o,v,__VA_ARGS__)
#define _hwa_cfoca_vupdate_0(o,v,...)		\
  HW_E_AVL(update mode of `o`, v, `immediately | after_bottom | after_top`)

#define _hwa_cfoca_vupdate_1(o,v,k,...)			\
  hwa->o.config.update = HW_A1(_hw_oca_update_##v);		\
  HW_Y(_hwa_cfoca_koutput_,_hw_is_output_##k)(o,k,__VA_ARGS__)

/*  Optionnal parameter `output`
 */
#define _hwa_cfoca_koutput_0(o,...)		\
   HW_EOL(__VA_ARGS__)

#define _hwa_cfoca_koutput_1(o,k,v,...)					\
  HW_Y(_hwa_cfoca_voutput_,_hw_oca_output_##v)(o,v,__VA_ARGS__)

#define _hwa_cfoca_voutput_0(o,v,...)			\
  HW_E_AVL(mode of `o`, v, `disconnected | toggle_after_match | clear_after_match | set_after_match | set_at_bottom_clear_after_match | clear_at_bottom_set_after_match | clear_after_match_up_set_after_match_down | set_after_match_up_clear_after_match_down`)
#define _hwa_cfoca_voutput_1(o,v,...)					\
  hwa->o.config.output = HW_A1(_hw_oca_output_##v) HW_EOL(__VA_ARGS__)
...
#define _hw_write_oca(o,a,v,...)	_hw_write(o,reg,v) HW_EOL(__VA_ARGS__)

#define hwa_write__oca		, _hwa_write_oca
#define _hwa_write_oca(o,a,v,...)	_hwa_write(o,reg,v) HW_EOL(__VA_ARGS__)

#define hw_read__oca			, _hw_read_oca
#define _hw_read_oca(o,a,...)	_hw_read(o,reg) HW_EOL(__VA_ARGS__)
...
#define _hw_trigger_oca(o,a)	_hw_write(o,force,1)

#define hwa_trigger__oca		, _hwa_trigger_oca
#define _hwa_trigger_oca(o,a)	_hwa_write(o,force,1)
...
#define _hwa_setup__oca(o,a)			\
  _hwa_setup_r( o, reg );			\
  hwa->o.config.update	= 0xFF ;		\
  hwa->o.config.output	= 0xFF ;

#define _hwa_init__oca(o,a)			_hwa_init_r( o, reg, 0x00 )

#define _hwa_commit__oca(o,a)		_hwa_commit_r( o, reg )
