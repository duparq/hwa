...
#define _hw_cfic16b(o,i,a,...)						\
  HW_GX(_hw_cfic16bkw1,_hw_cfic16b_kw_##__VA_ARGS__)(o,__VA_ARGS__,)
...
#define _hw_cfic16b_edge(o,v,...)					\
  HW_GX(_hw_cfic16b_vedge,hw_ic16b_edge_##v)(o,v,__VA_ARGS__)
...
#define _hwa_cfic16b(o,i,a,...)						\
  do {									\
    HW_GX(_hwa_cfic16b_kinput,_hw_is_input_##__VA_ARGS__)(o,__VA_ARGS__,,) \
      } while(0)
...
#define _hwa_cfic16b_kinput_1(o,k,v,...)				\
  HW_GX(_hwa_cfic16b_vinput,hw_ic16b_input_##v)(o,v,__VA_ARGS__)
...
#define _hwa_cfic16b_vinput_1(o,v,k,...)				\
  ...
  HW_GX(_hwa_cfic16b_kedge,_hw_is_edge_##k)(o,k,__VA_ARGS__)

#define _hwa_cfic16b_kedge_0(o,k,...)					\
  HW_E_VL(k,edge)

#define _hwa_cfic16b_kedge_1(o,k,v,...)				\
  HW_GX(_hwa_cfic16b_vedge,hw_ic16b_edge_##v)(o,v,__VA_ARGS__)
...
#define _hwa_cfic16b_vedge_1(o,v,k,...)				\
  ...
  HW_GX(_hwa_cfic16b_kfilter,_hw_is_filter_##k)(o,k,__VA_ARGS__)

#define _hwa_cfic16b_kfilter_0(o,...)		\
  HW_EOL(__VA_ARGS__)

#define _hwa_cfic16b_kfilter_1(o,k,v,...)				\
  HW_GX(_hwa_cfic16b_vfilter,_hw_state_##v)(o,v,__VA_ARGS__)
