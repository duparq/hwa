...
#define _hwa_cfc16a(o,i,a, ...)					\
  do { HW_GX(_hwa_cfc16a_kclock,_hw_is_clock_##__VA_ARGS__)(o,__VA_ARGS__,,) } while(0)

#define _hwa_cfc16a_kclock_0(o,k,...)				\
  HW_E_VL(k,clock)

#define _hwa_cfc16a_kclock_1(o,k,v,...)				\
  HW_GX(_hwa_cfc16a_vclock,_hw_c16a_clock_##v)(o,v,__VA_ARGS__)
...
#define _hwa_cfc16a_vclock_1(o,v,k,...)					\
  ...
  HW_GX(_hwa_cfc16a_kmode,_hw_is_countmode_##k)(o,k,__VA_ARGS__)
...
#define _hwa_cfc16a_kmode_1(o,k,v,...)					\
  HW_GX(_hwa_cfc16a_vmode,_hw_c16a_countmode_##v)(o,v,__VA_ARGS__)
...
#define _hwa_cfc16a_vmode_1(o,v,k,...)					\
  ...
  HW_GX(_hwa_cfc16a_kbottom,_hw_is_bottom_##k)(o,k,__VA_ARGS__)
...
#define _hwa_cfc16a_vbottom_1(o,v,k,...)	\
  HW_GX(_hwa_cfc16a_ktop,_hw_is_top_##k)(o,k,__VA_ARGS__)
...
#define _hwa_cfc16a_vtop_1(o,v,k,...)					\
  ...
  HW_GX(_hwa_cfc16a_koverflow,_hw_is_overflow_##k)(o,k,__VA_ARGS__)
				    ...
				    hwa_cmp16a_t *compare1, hwa_cap16a_t *ic0 )
{
  ...
  if ( overflow == 0xFF && c->config.top == HW_A1(_hw_c16a_top_compare0) ) {
    ...
    else /* if ( c->config.countmode == HW_A1(_hw_c16a_countmode_up_loop) ) */
