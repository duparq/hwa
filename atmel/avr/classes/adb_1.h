...
/**
 * @page atmelavr_adb Class _adb: 10-bit analog to digital converter
 *
 * A class `_adb` object is an analog to digital converter with the following
 * features:
 *
 ...
 * @endcode
 */
#define HW_BITS__adb		, _hw_bn_adb
#define _hw_bn_adb(o,a,...)		10 HW_EOL(__VA_ARGS__)
 ...
 * @par Interrupts
 *
 * Class `_adb` objects can trigger the following IRQs:
 *
