...
#define _hwa_cfusia( o,i,a,... )					\
  do {									\
    uint8_t mode, clock ;						\
    HW_GX(_hwa_cfusia_kmode,_hw_is_mode_##__VA_ARGS__)(o,__VA_ARGS__,,)	\
      } while(0)
#define _hwa_cfusia_kmode_0(o,k,...)	HW_E_VL(k, mode)
#define _hwa_cfusia_kmode_1(o,kw,...)	HW_GX(_hwa_cfusia_vmode,_hw_usia_mode_##__VA_ARGS__)(o,__VA_ARGS__)
...
#define _hwa_cfusia_vmode_1(o,v,...)					\
  ...
  HW_GX(_hwa_cfusia_kclock,_hw_is_clock_##__VA_ARGS__)(o,__VA_ARGS__)
