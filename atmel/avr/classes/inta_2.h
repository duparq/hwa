 ...
 * @endcode
 */
#define _hw_mtd_hw_configure__inta	, _hw_cfinta
 ...
 * @endcode
 */
#define _hw_mtd_hwa_configure__inta	, _hwa_cfinta
...
#define _hwx_cfinta(x,o,k,...)					\
  HW_Y(_hwx_cfinta_ksense,_hw_is_sense_##k)(x,o,k,__VA_ARGS__)

#define _hwx_cfinta_ksense_0(x,o,k,...)			\
  HW_E_VL(k,sense)

#define _hwx_cfinta_ksense_1(x,o,k,v,...)				\
  HW_Y(_hwx_cfinta_vsense,_hw_inta_sense_##v)(x,o,v,__VA_ARGS__)
