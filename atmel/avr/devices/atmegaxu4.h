 ...
 * @defgroup atmegaxu4 ATmega16U4/32U4
 *
...
#else
HW_E(HW_EM_VAL(HW_DEVICE_CLK_PSC,HW_DEVICE_CLK_PSC,(1,8)))
#endif
 ...
 * `porte`	 | @ref atmelavr_gpa "_gpa"	   | General purpose I/O port D (PORTE)
 * `portf`	 | @ref atmelavr_gpa "_gpa"	   | General purpose I/O port D (PORTF)
 ...
 * `prescaler0`	 | @ref atmelavr_psa "_psa"	   | counter0/1/3 prescaler (PSC0)
 * `counter0` | @ref atmelavr_cta "_cta"	   | 8-bit counter-timer (T0)
 * `counter0compare0`	 | @ref atmelavr_oca "_oca"	   | Compare unit 0 of counter0 (OC0A)
 * `counter0compare1`	 | @ref atmelavr_oca "_oca"	   | Compare unit 1 of counter0 (OC0B)
 * `counter1` | @ref atmelavr_cte "_cte"	   | 16-bit counter-timer (T1)
 * `counter1compare0`	 | @ref atmelavr_occ "_occ"	   | Compare unit 0 of counter1 (OC1A)
 * `counter1compare1`	 | @ref atmelavr_occ "_occ"	   | Compare unit 1 of counter1 (OC1B)
 * `counter1compare2`	 | @ref atmelavr_occ "_occ"	   | Compare unit 2 of counter1 (OC1C)
 * `counter1capture0`	 | @ref atmelavr_ica "_ica"	   | Capture unit of counter1 (ICP1)
 * `counter3` | @ref atmelavr_cte "_cte"	   | 16-bit counter-timer (T1)
 * `counter3compare0`	 | @ref atmelavr_occ "_occ"	   | Compare unit 0 of counter3 (OC3A)
 * `counter3compare1`	 | @ref atmelavr_occ "_occ"	   | Compare unit 1 of counter3 (OC3B)
 * `counter3compare2`	 | @ref atmelavr_occ "_occ"	   | Compare unit 2 of counter3 (OC3C)
 * `counter3capture0`	 | @ref atmelavr_ica "_ica"	   | Capture unit of counter3 (ICP3)
 ...
 */
#define hw_shared_did1			_r8, 0x7F, 0x01, 0x00	/* DID for AIN0 */
#define hw_shared_did0			_r8, 0x7E, 0xF3, 0x00
#define hw_shared_did2			_r8, 0x7D, 0x3F, 0x00
#define hw_shared_eicrb			_r8, 0x6A, 0x30, 0x00
#define hw_shared_eicra			_r8, 0x69, 0xFF, 0x00
#define hw_shared_pcicr			_r8, 0x68, 0x01, 0x00
#define hw_shared_prr1			_r8, 0x65, 0x99, 0x00
#define hw_shared_prr0			_r8, 0x64, 0xAD, 0x00
...
#define hw_shared_eimsk			_r8, 0x3D, 0x4F, 0x00
#define hw_shared_eifr			_r8, 0x3C, 0x4F, 0x4F
#define hw_shared_pcifr			_r8, 0x3B, 0x01, 0x01
...
#define hw_core0_sph			_r8, 0x5E, 0xFF, 0x00
#define hw_core0_spl			_r8, 0x5D, 0xFF, 0x00
#define hw_core0_mcucr			_r8, 0x55, 0x53, 0x00
#define hw_core0_mcusr			_r8, 0x54, 0x3F, 0x00
...
#define hw_core0_usbrf			_ob1, mcusr, 1, 5
#define hw_core0_jtrf			_ob1, mcusr, 1, 4
...
#define hw_core0_allrf			_ob1, mcusr, 6, 0	/* convenient */
...
/*	Object				class, id, address
 */
#define hw_watchdog0			_wdb, 103, 0
 ...
 * `port_f`	|	      | @ref atmelavr_ioa "_ioa" | PORTF
 * `pf0` | `pin_41` | @ref atmelavr_ioa "_ioa" | PF0
 * `pf1` | `pin_40` | @ref atmelavr_ioa "_ioa" | PF1
 * `pf4` | `pin_39` | @ref atmelavr_ioa "_ioa" | PF4
 * `pf5` | `pin_38` | @ref atmelavr_ioa "_ioa" | PF5
 * `pf6` | `pin_37` | @ref atmelavr_ioa "_ioa" | PF6
 * `pf7` | `pin_36` | @ref atmelavr_ioa "_ioa" | PF7
 */
...
#define hw_portb			_gpa, 104, 0x23
#define hw_portc			_gpa, 105, 0x26
#define hw_portd			_gpa, 106, 0x29
#define hw_porte			_gpa, 107, 0x2C
#define hw_portf			_gpa, 108, 0x2F

/*  Pins				class, id, port, bn, bp
 */
#define hw_pb0				_ioa, 109, portb, 1, 0
#define hw_pb1				_ioa, 110, portb, 1, 1
#define hw_pb2				_ioa, 111, portb, 1, 2
#define hw_pb3				_ioa, 112, portb, 1, 3
#define hw_pb4				_ioa, 113, portb, 1, 4
#define hw_pb5				_ioa, 114, portb, 1, 5
#define hw_pb6				_ioa, 115, portb, 1, 6
#define hw_pb7				_ioa, 116, portb, 1, 7

#define hw_pc6				_ioa, 117, portc, 1, 6
#define hw_pc7				_ioa, 118, portc, 1, 7

#define hw_pd0				_ioa, 119, portd, 1, 0
#define hw_pd1				_ioa, 120, portd, 1, 1
#define hw_pd2				_ioa, 121, portd, 1, 2
#define hw_pd3				_ioa, 122, portd, 1, 3
#define hw_pd4				_ioa, 123, portd, 1, 4
#define hw_pd5				_ioa, 124, portd, 1, 5
#define hw_pd6				_ioa, 125, portd, 1, 6
#define hw_pd7				_ioa, 126, portd, 1, 7

#define hw_pe2				_ioa, 127, porte, 1, 2
#define hw_pe6				_ioa, 128, porte, 1, 6

#define hw_pf0				_ioa, 129, portf, 1, 0
#define hw_pf1				_ioa, 130, portf, 1, 1
#define hw_pf4				_ioa, 131, portf, 1, 4
#define hw_pf5				_ioa, 132, portf, 1, 5
#define hw_pf6				_ioa, 133, portf, 1, 6
#define hw_pf7				_ioa, 134, portf, 1, 7

/*  Not connected pins
 */
#include "../classes/io0a_1.h"

#define hw_counter3compare1		_ionc
#define hw_counter3compare2		_ionc

/*  Digital input disable bits for analog input pins
 */
#define hw_pf0_did			_xb1, shared, did0, 1, 0	/* ADC0 */
#define hw_pf1_did			_xb1, shared, did0, 1, 1	/* ADC1 */
#define hw_pf4_did			_xb1, shared, did0, 1, 4	/* ADC4 */
#define hw_pf5_did			_xb1, shared, did0, 1, 5	/* ADC5 */
#define hw_pf6_did			_xb1, shared, did0, 1, 6	/* ADC6 */
#define hw_pf7_did			_xb1, shared, did0, 1, 7	/* ADC7 */

#define hw_pd4_did			_xb1, shared, did2, 1, 0	/* ADC8 */
#define hw_pd6_did			_xb1, shared, did2, 1, 1	/* ADC9 */
#define hw_pd7_did			_xb1, shared, did2, 1, 2	/* ADC10 */
#define hw_pb4_did			_xb1, shared, did2, 1, 3	/* ADC11 */
#define hw_pb5_did			_xb1, shared, did2, 1, 4	/* ADC12 */
#define hw_pb6_did			_xb1, shared, did2, 1, 5	/* ADC13 */

#define hw_pe6_did			_xb1, shared, did1, 1, 0	/* AIN0 */

/*  Pin change controller mask
 */
#define hw_pb0_pcic			_xb1, 135, msk, 1, 0
#define hw_pb1_pcic			_xb1, 136, msk, 1, 1
#define hw_pb2_pcic			_xb1, 137, msk, 1, 2
#define hw_pb3_pcic			_xb1, 138, msk, 1, 3
#define hw_pb4_pcic			_xb1, 139, msk, 1, 4
#define hw_pb5_pcic			_xb1, 140, msk, 1, 5
#define hw_pb6_pcic			_xb1, 141, msk, 1, 6
#define hw_pb7_pcic			_xb1, 142, msk, 1, 7
...
/*	Object logical registers
 */
#define hw_int0_sc			_xb1, shared, eicra, 2, 0
...
/*	Object logical registers
 */
#define hw_int1_sc			_xb1, shared, eicra, 2, 2
...
/*	Object logical registers
 */
#define hw_int2_sc			_xb1, shared, eicra, 2, 4
#define hw_int2_ie			_xb1, shared, eimsk, 1, 2
#define hw_int2_if			_xb1, shared, eifr,  1, 2
...
/*	Object logical registers
 */
#define hw_int3_sc			_xb1, shared, eicra, 2, 6
#define hw_int3_ie			_xb1, shared, eimsk, 1, 3
#define hw_int3_if			_xb1, shared, eifr,  1, 3
...
/*	Object logical registers
 */
#define hw_int6_sc			_xb1, shared, eicrb, 2, 4
#define hw_int6_ie			_xb1, shared, eimsk, 1, 6
#define hw_int6_if			_xb1, shared, eifr,  1, 6
...
/*	Object				class, id, address
 */
#define hw_prescaler0			_psa, 149, 0
...
/*	Object				class, id, address
 */
#define hw_counter0compare0		_oca, 151, 0

/*	Object hardware registers	class, address, write mask, flags mask
 */
#define hw_counter0compare0_reg		_r8, 0x47, 0xFF, 0x00	/* OCR0A */

/*	Object logical registers
 */
#define hw_counter0compare0_com		_xb1, counter0, ccra, 2, 6
#define hw_counter0compare0_force	_xb1, counter0, ccrb, 1, 7
#define hw_counter0compare0_ie		_xb1, counter0, imsk, 1, 1
#define hw_counter0compare0_if		_xb1, counter0, ifr,  1, 1
...
/*	Object				class, id, address
 */
#define hw_counter0compare1		_oca, 152, 0

/*	Object hardware registers	class, address, write mask, flags mask
 */
#define hw_counter0compare1_reg		_r8, 0x48, 0xFF, 0x00	/* OCR0B */

/*	Object logical registers
 */
#define hw_counter0compare1_com		_xb1, counter0, ccra, 2, 4
#define hw_counter0compare1_force	_xb1, counter0, ccrb, 1, 6
#define hw_counter0compare1_ie		_xb1, counter0, imsk, 1, 2
#define hw_counter0compare1_if		_xb1, counter0, ifr,  1, 2
...
#include "../classes/cte_1.h"

/*	Object				class, id, address
 */
#define hw_counter1			_cte, 153, 0
...
#define hw_counter1_imsk		_r8,  0x6F, 0x2F,   0x00
#define hw_counter1_ifr			_r8,  0x36, 0x2F,   0x2F
...
#define hw_counter1_prr			_xb1, shared, prr0, 1, 3
...
/*	Object				class, id, address
 */
#define hw_counter1compare0		_occ, 154, 0

/*	Object hardware registers	class, address, write mask, flags mask
 */
#define hw_counter1compare0_reg		_r16, 0x88, 0xFFFF, 0x0000	/* OCR1A */

/*	Object logical registers
 */
#define hw_counter1compare0_com		_xb1, counter1, ccra, 2, 6
#define hw_counter1compare0_force	_xb1, counter1, ccrc, 1, 7
#define hw_counter1compare0_ie		_xb1, counter1, imsk, 1, 1
#define hw_counter1compare0_if		_xb1, counter1, ifr,  1, 1
...
/*	Object				class, id, address
 */
#define hw_counter1compare1		_occ, 155, 0

/*	Object hardware registers	class, address, write mask, flags mask
 */
#define hw_counter1compare1_reg		_r16, 0x8A, 0xFFFF, 0x0000	/* OCR1B */

/*	Object logical registers
 */
#define hw_counter1compare1_com		_xb1, counter1, ccra, 2, 4
#define hw_counter1compare1_force	_xb1, counter1, ccrc, 1, 6
#define hw_counter1compare1_ie		_xb1, counter1, imsk, 1, 2
#define hw_counter1compare1_if		_xb1, counter1, ifr,  1, 2
...
/*	Object				class, id, address
 */
#define hw_counter1compare2		_occ, 413, 0

/*	Object hardware registers	class, address, write mask, flags mask
 */
#define hw_counter1compare2_reg		_r16, 0x8C, 0xFFFF, 0x0000

/*	Object logical registers
 */
#define hw_counter1compare2_com		_xb1, counter1, ccra, 2, 2
#define hw_counter1compare2_force	_xb1, counter1, ccrc, 1, 5
#define hw_counter1compare2_ie		_xb1, counter1, imsk, 1, 3
#define hw_counter1compare2_if		_xb1, counter1, ifr,  1, 3
...
/*	Object				class, id, address
 */
#define hw_counter1capture0		_ica, 156, 0

/*	Object hardware registers	class, address, write mask, flags mask
 */
#define hw_counter1capture0_reg		_r16, 0x86, 0xFFFF, 0x0000	/* ICR1 */

/*	Object logical registers
 */
#define hw_counter1capture0_acic	_xb1, acmp0, csr, 1, 2
#define hw_counter1capture0_icnc	_xb1, counter1, ccrb, 1, 7
#define hw_counter1capture0_ices	_xb1, counter1, ccrb, 1, 6
#define hw_counter1capture0_ie		_xb1, counter1, imsk, 1, 5
#define hw_counter1capture0_if		_xb1, counter1, ifr,  1, 5
...
/*	Object				class, id, address
 */
#define hw_counter3			_cte, 157, 0

/*	Object hardware registers	class, address, write mask, flags mask
 */
#define hw_counter3_ccra		_r8,  0x90, 0xF3,   0x00
#define hw_counter3_ccrb		_r8,  0x91, 0xDF,   0x00
#define hw_counter3_ccrc		_r8,  0x92, 0xC0,   0x00
#define hw_counter3_count		_r16, 0x94, 0xFFFF, 0x0000
#define hw_counter3_imsk		_r8,  0x71, 0x2F,   0x00
#define hw_counter3_ifr			_r8,  0x38, 0x2F,   0x2F

/*	Object logical registers
 */
#define hw_counter3_cs			_ob1, ccrb, 3, 0
#define hw_counter3_wgm			_ob2, ccrb, 2, 3, 2, ccra, 2, 0, 0
#define hw_counter3_ie			_ob1, imsk, 1, 0
#define hw_counter3_if			_ob1, ifr,  1, 0
#define hw_counter3_prr			_xb1, shared, prr1, 1, 3
...
/*	Object				class, id, address
 */
#define hw_counter3compare0		_occ, 158, 0

/*	Object hardware registers	class, address, write mask, flags mask
 */
#define hw_counter3compare0_reg		_r16, 0x98, 0xFFFF, 0x0000	/* OCR1A */

/*	Object logical registers
 */
#define hw_counter3compare0_com		_xb1, counter3, ccra, 2, 6
#define hw_counter3compare0_force	_xb1, counter3, ccrc, 1, 7
#define hw_counter3compare0_ie		_xb1, counter3, imsk, 1, 1
#define hw_counter3compare0_if		_xb1, counter3, ifr,  1, 1
...
/*	Object				class, id, address
 */
#define hw_counter3compare1		_occ, 159, 0

/*	Object hardware registers	class, address, write mask, flags mask
 */
#define hw_counter3compare1_reg		_r16, 0x9A, 0xFFFF, 0x0000	/* OCR1B */

/*	Object logical registers
 */
#define hw_counter3compare1_com		_xb1, counter3, ccra, 2, 4
#define hw_counter3compare1_force	_xb1, counter3, ccrc, 1, 6
#define hw_counter3compare1_ie		_xb1, counter3, imsk, 1, 2
#define hw_counter3compare1_if		_xb1, counter3, ifr,  1, 2
...
/*	Object				class, id, address
 */
#define hw_counter3compare2		_occ, 433, 0

/*	Object hardware registers	class, address, write mask, flags mask
 */
#define hw_counter3compare2_reg		_r16, 0x9C, 0xFFFF, 0x0000

/*	Object logical registers
 */
#define hw_counter3compare2_com		_xb1, counter3, ccra, 2, 2
#define hw_counter3compare2_force	_xb1, counter3, ccrc, 1, 5
#define hw_counter3compare2_ie		_xb1, counter3, imsk, 1, 3
#define hw_counter3compare2_if		_xb1, counter3, ifr,  1, 3
...
#include "../classes/icb_1.h"

/*	Object				class, id, address
 */
#define hw_counter3capture0		_icb, 160, 0

/*	Object hardware registers	class, address, write mask, flags mask
 */
#define hw_counter3capture0_reg		_r16, 0x96, 0xFFFF, 0x0000	/* ICR3 */

/*	Object logical registers
 */
#define hw_counter3capture0_acic	_xb1, acmp0, csr, 1, 2
#define hw_counter3capture0_icnc	_xb1, counter3, ccrb, 1, 7
#define hw_counter3capture0_ices	_xb1, counter3, ccrb, 1, 6
#define hw_counter3capture0_ie		_xb1, counter3, imsk, 1, 5
#define hw_counter3capture0_if		_xb1, counter3, ifr,  1, 5
...
typedef struct {
  ...
  hwa_occ_t	counter1compare2 ;
  hwa_ica_t	counter1capture0 ;

  hwa_cte_t	counter3 ;
  hwa_occ_t	counter3compare0 ;
  hwa_occ_t	counter3compare1 ;
  hwa_occ_t	counter3compare2 ;
  hwa_ica_t	counter3capture0 ;
...
#include "../classes/icb_2.h"
#include "../classes/occ_2.h"
#include "../classes/cte_2.h"
