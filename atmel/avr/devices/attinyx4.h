 ...
 * @page attinyx4
 *
 * @section attinyx4_device Device description and configuration
 *
 * HWA provides definitions that describe the device and its hardware
 * configuration.
 *
 * @subsection attinyx4_device_desc Device description
 *
 * Symbol               | Possible values | Comments
 * :--------------------|--------------|:-----------
 * `HW_DEVICE`          | `attiny24`<br>`attiny44`<br>`attiny84` | Name of the device
 * `HW_DEVICE_ATTINY24`<br>`HW_DEVICE_ATTINY44`<br>`HW_DEVICE_ATTINY84`<br> | | Depending on the HWA header included
 * `HW_DEVICE_PACKAGE`  | `14pdip`     | Packaging of the device.
 * `HW_DEVICE_ATTINYX4`        | (Void) | Always defined
...
/**
 * @page attinyx4
 * @subsubsection attinyx4_fuses_sut Startup delays
 *
 * Symbol               | Valid values | Comments
 * :--------------------|--------------|:-----------
...
/**
 * @page attinyx4
 * @subsubsection attinyx4_fuses_other Other fuses
 *
 * Symbol                 | Valid values | Comments
 * :----------------------|--------------|:-----------
