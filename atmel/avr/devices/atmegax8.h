...
/**
 * @file
 * @brief HWA for ATmega48A/PA/88A/PA/168A/PA/328/P
 */
...
#include "../classes/io_1.h"
#include "../classes/pin1a_1.h"
#include "../classes/pcicb_1.h"
#include "../classes/wdogb_1.h"
#include "../classes/ocua_1.h"
#include "../classes/icua_1.h"
...
#define _hw_core0_gpior2		_r8, 0x4B, 0xFF, 0x00
#define _hw_core0_gpior1		_r8, 0x4A, 0xFF, 0x00
#define _hw_core0_gpior0		_r8, 0x3E, 0xFF, 0x00
 ...
 * @page atmegax8
 *
 * @section atmegax8_device Device description and configuration
 *
 * HWA provides definitions that describe the device and its hardware
 * configuration.
 *
 * @subsection atmegax8_device_desc Device description
 *
 * Symbol                      | Comments
 * :---------------------------|:--------------
 * `HW_DEVICE`                 | Name of the device: `atmega48a`, `atmega48a_au`...
 * `HW_DEVICE_ATMEGA48A`<br>`HW_DEVICE_ATMEGA48A_AU`<br>...| Defined (void) according to the device name
 * `HW_DEVICE_ATMEGAX8`        | Defined for Atmel AVR ATmega48A/PA/88A/PA/168A/PA/328/P
 * `HW_DEVICE_ATMELAVR`        | Defined for all Atmel AVR devices (void)
 * `HW_DEVICE_VENDOR`          | Defined for all Atmel AVR devices as `atmel`
 * `HW_DEVICE_ARCH`            | Defined for all Atmel AVR devices as `avr`
 * `HW_DEVICE_PACKAGE_28A`<br>`HW_DEVICE_PACKAGE_32Q`<br>...| Packaging of the device.
 ...
 * `hw_syshz`                  | CPU clock frequency in cycles per second
 */

/**
 * @page atmegax8
 * @subsection atmegax8_fuses Fuses
 *
 * @subsubsection atmegax8_fuses_clocking Clocking
 *
 ...
 * defined by the user, HWA will define them with the factory values (shown with
 * a bold face).
 *
...
/**
 * @page atmegax8
 * @subsubsection atmegax8_fuses_sut Startup delays
 *
 * Symbol               | Valid values | Comments
 * :--------------------|--------------|:-----------
...
/**
 * @page atmegax8
 * @subsubsection atmegax8_fuses_other Other fuses
 *
 * Symbol                 | Valid values | Comments
 * :----------------------|--------------|:-----------
