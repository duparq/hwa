 ...
 */
#define hw_class(...)		HW_G2(_hw_class, HW_IS(0,hw_type(__VA_ARGS__)))(__VA_ARGS__,)
#define _hw_class_1(...)	HW_ERR("first argument is not defined.")
#define _hw_class_0(t,c,...)	c
