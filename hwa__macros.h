...
#define hw_is_hw_error_hw_error		, 1, /* one more comma to remove '; StaticAssert(...)' */
...
/*	1 if the 2nd argument of hw_is_x_y is 1, 0 if not
 */
...
#define _HW_MTHD1(f,p,...)	_HW_MTHD2(f,p,hw_##p,__VA_ARGS__)
#define _HW_MTHD2(...)		_HW_MTHD3(__VA_ARGS__)

/* Is there a method f for assumed object p of class c? */
// MCUSR = x_HW_MTHD4_0(_hw_addr,_m1,hw__m1,core0,0, mcusr,8,0x54,0x0F,0x00, 8,0)
...
//  BP_EXTRF = x_HW_MTHD5_0(hw_bp,_m1,hw__m1,core0,0, mcusr,8,0x54,0x0F,0x00, 1,1)
#define _HW_MTHD4_0(f,p,c,...)	HW_G2(_HW_MTHD5, HW_IS(,hw_class_##c))(f,p,c,__VA_ARGS__)
#define _HW_MTHD5_1(f,p,c,...)	HW_ERR("object `"#p"` of class `"#c"` has no method `"#f"`.")

/* p is not an object. Is it a class name? */
//  BP_EXTRF = x_HW_MTHD6_1(hw_bp,_m1,hw__m1,core0,0, mcusr,8,0x54,0x0F,0x00, 1,1)
#define _HW_MTHD5_0(f,p,...)	HW_G2(_HW_MTHD6,HW_IS(,hw_class_##p))(f,p,__VA_ARGS__)
...
#define HW_MTHD(f,...)		HW_G2(_HW_MTHD2,HW_IS(,hw_class_##__VA_ARGS__))(f,__VA_ARGS__)
...
/* Assume the argument is the name of an object, expand its definition to get its class */
#define _HW_MTHD2_0(f,p,...)	_HW_MTHD4(f,p,hw_##p,__VA_ARGS__)
...
/* No method f for assumed object p of class c. Is p an object? */
#define _HW_MTHD5_0(f,p,c,...)	HW_G2(_HW_MTHD6, HW_IS(,hw_class_##c))(f,p,c,__VA_ARGS__)
 ...
 */
#define HW_GNRC(f,p,...)	_HW_GNRC_2(f,p,hw_##p,__VA_ARGS__)
#define _HW_GNRC_2(...)		_HW_GNRC_3(__VA_ARGS__)
#define _HW_GNRC_3(f,p,c,...)	HW_G2(_HW_GNRC,HW_IS(,hw_class_##c))(f,p,c,__VA_ARGS__)
#define _HW_GNRC_0(f,p,...)	HW_ERR("`"#p"` is not a HWA object")
#define _HW_GNRC_1(f,p,c,...)	f(c,p,__VA_ARGS__)


/*  1 if argument is the name of a HWA object, 0 if not
 */
#define HW_ISOBJ(...)		HW_IS(,HW_G2(hw_class,hw_##__VA_ARGS__))


/*  Expand to `result` if remaining argument is '', an error otherwise
 */
...
#define _hw_reg(p,m)			_hw__reg_2(p,hw_##p,m)
#define _hw__reg_2(...)			_hw__reg_3(__VA_ARGS__)
#define _hw__reg_3(p,c,i,a,m)		_hw__reg_4(hw_##c##_##m,p,c,a,m)
 ...
 *	'c'
 */
#define _hw_creg(c,m)			_hw__creg_4(hw_##c##_##m,_,c,_,m)
 ...
 *	-> _m1, p,a, r,rw,ra,rwm,rfm, bn,bp
 */
#define _hw_x_cb1(r,bn,bp, p,c,a,m)	_hw_xcb1_2(hw_##c##_##r,bn,bp,p,c,a,r)
...
#define _hw_x_cb2(r1,rbn1,rbp1,vbp1, r2,rbn2,rbp2,vbp2, p,c,a,m)	\
  _hw_xcb2_2( r1,hw_##c##_##r1,rbn1,rbp1,vbp1,			\
	      r2,hw_##c##_##r2,rbn2,rbp2,vbp2, p,c,a,m)
 ...
 */
#define _hw_x_irg(p,r, p0,c0,a0,r0)	_hw_xirg_2(hw_##p,p,r)
#define _hw_xirg_2(...)			_hw_xirg_3(__VA_ARGS__)
#define _hw_xirg_3(c,i,a,p,r)		_hw_xirg_4(hw_##c##_##r,p,c,a,r)
 ...
 */
#define _hw_xirg__cb1(r,bn,bp, p,c,a,m)	_hw_xirgcb1_2(hw_##c##_##r,bn,bp,p,c,a,r)
