...
#define HWA_PRPH_APBENR_HWA_UART1	HWA_APB2ENR, 0b1, 14
...
#define HWA_PRPH_APBENR_HWA_UART3	HWA_APB1ENR, 0b1, 18
#define HWA_PRPH_APBENR_HWA_UART2	HWA_APB1ENR, 0b1, 17
...
#define hwa_commit_prph()			\
  HWA_COMMIT(HWA_CORE0, HWA_PRPH, HWA_PRPH0, HWA_APB2ENR);	\
  HWA_COMMIT(HWA_CORE0, HWA_PRPH, HWA_PRPH0, HWA_APB1ENR);
