 ...
 * @endcode
 */
#define _hw_mtd_HW_BITS__io1b		, _hw_bn_io1b
 ...
 * @endcode
 */
#define _hw_mtd_HW_POSITION__io1b	, _hw_bp_io1b
 ...
 * @endcode
 */
#define _hw_mtd_hw_rel__io1b		, _hw_rel_io1b

#define _hw_rel_io1b(o,x,...)		HW_Y(_hw_rel_io1b,_hw_is_port_##x)(o,x,__VA_ARGS__)
