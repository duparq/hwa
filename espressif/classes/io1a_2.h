...
#define _hw_cfio1a3( o,cf,p,bn,bp, ...)					\
  do{									\
    ...
    _hwa_setup( p );							\
    _hwa_setup( cf );							\
    HW_X(_hwa_cfio1a_kfunction,_hw_is_function_##__VA_ARGS__)(o,cf,p,bn,bp,__VA_ARGS__,,); \
...
#define _hwa_cfio1a_kfunction_1(o,cf,p,bn,bp,k,v,...)				\
  HW_X(_hwa_cfio1a_vfunction,_##o##_fn_##v)(o,cf,p,bn,bp,v,__VA_ARGS__)
...
#define _hwa_cfio1a_vfunction_1(o,cf,p,bn,bp,v,k,...)			\
  ...
  HW_X(_hwa_cfio1a_kdirection,_hw_is_direction_##k)(o,cf,p,bn,bp,k,__VA_ARGS__)
...
#define _hwa_cfio1a_kdirection_1(o,cf,p,bn,bp,k,v,...)				\
  HW_X(_hwa_cfio1a_vdirection,_hw_cfio1a_direction_##v)(o,cf,p,bn,bp,v,__VA_ARGS__)
...
#define _hwa_cfio1a_vdirection_1(o,cf,p,bn,bp,v,k,...)			\
  ...
  HW_X(_hwa_cfio1a_kpullup,_hw_is_pullup_##k)(o,cf,p,bn,bp,k,__VA_ARGS__)
...
#define _hwa_cfio1a_kpullup_1(o,cf,p,bn,bp,k,v,...)				\
    HW_X(_hwa_cfio1a_vpullup0,_hw_cfio1a_pullup_##v)(o,cf,p,bn,bp,v,__VA_ARGS__)
