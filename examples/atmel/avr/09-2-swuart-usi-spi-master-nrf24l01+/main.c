 ...
 *	hw_spimaster0 instead of hw_usi0 can simplify the application.
 *
 *	Test: ./main.py
 *
 ...
 *	MOSI <-	MISO (7)(8)  IRQ
 *
 *	NOTE: pin MISO, output of the nRF, has to be connected to pin MOSI of
 *	the MCU (considered as a slave regarding the pin names).
 *
