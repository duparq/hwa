#!/usr/bin/env python
# -*- coding: utf-8 -*- Last modified: 2015-05-02 11:59:07 -*-
...
class Com:
    ...
    def open(self):
        ...
        #
        #  FIXME Timeout: may be choose a differently value according to how
        #  many wires are used?
        #
        self.btimeout = max(0.01, 33.0/self.baud)
        #self.btimeout = max(0.003, 11.0/self.baud)
        #self.btimeout = 33.0/self.baud
