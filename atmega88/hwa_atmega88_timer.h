#ifndef HWA_ATMEGA88_TIMER_H
#define HWA_ATMEGA88_TIMER_H
...
/* #define HWA_TIMER_HWA_CMPA		, u32, 0, 0, 0xFFFFFFFF */
/* #define HWA_TIMER_HWA_CMPB		, u32, 0, 0, 0xFFFFFFFF */


#define HWA_TIMER_MODE_NORMAL		1

/* #define HWA_TIMER_MODE_PERIODIC_IRQ	1 */
/* #define HWA_TIMER_MODE_COUNTER		2 */
/* #define HWA_TIMER_MODE_MAX_LOOP		2 */
/* #define HWA_TIMER_MODE_LOOP_MAX		2 */
/* #define HWA_TIMER_MODE_LOOP_ON_OVERFLOW	3 */
#define HWA_TIMER_MODE_LOOP		4
/* #define HWA_TIMER_MODE_MATCH_LOOP	4 */
/* #define HWA_TIMER_MODE_LOOP_ON_MATCH	4 */
...
#define hw_timer_write_count(pname, value)	\
  HW_HR(pname, pname, HWA_CNT) = value ;
...
/* #define hw_timer_flag_is_set(pname, flag)			\ */
...
/* #define hw_timer_set_period(pname, period)\ */
/*   HW_SETHR(pname, pname, HWA_OCRA, period) */
...
/* #define hwa_timer_config_pin(p, chan, mode)	\ */
/*   hwa_gpio_config_pin(HWA_G2(p, PIN_##chan), mode) */
...
#include "hwa_atmega88_timer0.h"
#include "hwa_atmega88_timer1.h"
#include "hwa_atmega88_timer2.h"
