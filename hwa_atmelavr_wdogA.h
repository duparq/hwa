 ...
 */
#define hw_def_hw_turn_wdogA		, _hw_turn_wdog
#define hw_def_hwa_turn_wdogA		, _hwa_turn_wdog
#define hw_def_hw_reset_wdogA		, _hw_wdreset
#define hw_def_hwa_config_wdogA		, _hwa_cfwdog
#define hw_def_hw_stat_wdogA		, _hw_stat_wdog
