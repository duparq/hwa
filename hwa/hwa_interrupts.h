...
#define _hw_tnirq_1(o,e,v, ...)		_hw_write_or(o,e, HW_A1(_hw_state_##v)) HW_EOL(__VA_ARGS__)
...
#define _hwa_tnirq_1(o,e,v, ...)	_hwa_write_or(o,e, HW_A1(_hw_state_##v)) HW_EOL(__VA_ARGS__)
...
#define _hw_clear_irq(v,p,e,f,...)	_hw_write_or(p,f,1) HW_EOL(__VA_ARGS__)
...
#define _hwa_clear_irq(v,p,e,f,...)	_hwa_write_or(p,f,1) HW_EOL(__VA_ARGS__)
